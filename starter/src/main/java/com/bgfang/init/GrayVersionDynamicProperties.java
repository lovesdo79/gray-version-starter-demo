 ...
 */
@Slf4j
public class GrayVersionDynamicProperties implements InitializingBean {
    ...
    public GrayVersionDynamicProperties(NacosConfigProperties nacosConfigProperties) {
    ...
    private void initGrayTag() {
        ...
        GrayVersionDynamicProperties.GRAY_TAG = System.getProperty(CommonConstant.GRAY_TAG);
    }
