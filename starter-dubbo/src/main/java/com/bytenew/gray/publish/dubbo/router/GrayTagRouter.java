...
public class GrayTagRouter extends AbstractRouter {
    ...
    private GrayPublishDynamicProperties properties;

    public void setProperties(GrayPublishDynamicProperties properties) {
        this.properties = properties;
    }

    public GrayTagRouter(URL url, GrayPublishDynamicProperties properties) {
        super(url);
        this.properties = properties;
    }
